...
import hyun6ik.shoppingmall.domain.login.oauth2.userinfo.GoogleUserInfo;
...
public class GoogleLoginService implements SocialLoginService {
    ...
    public boolean support(String registrationId) {
        return MemberType.GOOGLE.equals(MemberType.valueOf(registrationId.toUpperCase()));
    }
    ...
    public OAuth2Attributes getUserInfo(OAuth2User oAuth2User, String registrationId, OAuth2UserRequest userRequest) {
        ...
        return GoogleUserInfo.of(registrationId, userNameAttributeName, oAuth2User.getAttributes());
    }
}
