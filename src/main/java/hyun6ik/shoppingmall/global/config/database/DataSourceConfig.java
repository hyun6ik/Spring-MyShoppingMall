...
public class DataSourceConfig {
    ...
    public DataSourceConfig(MasterDataSourceProperties dataSourceProperties, JpaProperties jpaProperties) {
    ...
    public DataSource routingDataSource() {
        DataSource master = createDataSource(dataSourceProperties.getUrl(), dataSourceProperties.getUsername(), dataSourceProperties.getPassword());
